let chalk,fs,ncp,path,readline,promisify;_73a‍.x([["createWidget",()=>createWidget]]);_73a‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_73a‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_73a‍.w("ncp",[["default",["ncp"],function(v){ncp=v}]]);_73a‍.w("path",[["default",["path"],function(v){path=v}]]);_73a‍.w("readline",[["default",["readline"],function(v){readline=v}]]);_73a‍.w("util",[["promisify",["promisify"],function(v){promisify=v}]]);
...
// TODO: lots validation: if folder exists, etc
  ...
  const currentFileUrl = _73a‍._.meta.url;
  ...
  _73a‍.g.console.log(widgetFolder);
  _73a‍.g.console.log(options);

  // Read dir
  try {
    await access(templateDir, fs.constants.R_OK);
  } catch (err) {
    _73a‍.g.console.error("%s Invalid template name", chalk.red.bold("ERROR"));
    process.exit(1);
  }
  ...
  try {
    ...
    _73a‍.g.console.error("%s: %s", chalk.red.bold("ERROR"), e.message);
    process.exit(1);
  }
  ...
  _73a‍.g.console.log("%s Widget ready", chalk.green.bold("Done"));
...
function updateModule(options) {
  ...
  try {
    const array = _73a‍.u(eval(_73a‍.c(la)));
    ...
    _73a‍.g.console.error(`%s ${e.message}`, chalk.red.bold("ERROR"));
    process.exit(1);
  }
}
